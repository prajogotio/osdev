...
extern void TssFlush(uint16_t tss_selector);
extern void TssInstall(uint32_t index, uint16_t kernel_segment_selector, uint16_t kernel_esp);

extern void RingEnterUserMode(uint32_t cr3, uint32_t esp);
